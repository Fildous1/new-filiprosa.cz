...
const translations: Record<Locale, Record<string, string>> = {
  cs: {
    ...
    'services.description': 'Od zachycení momentu po finální tisk \u2014 kompletní fotografický servis se zaměřením na ruční proces.',
    'services.capture.title': 'Zachytění momentu',
    'services.capture.subtitle': 'Fotografie',
    'services.capture.desc': 'Portrétní, produktová a eventová fotografie. Digitální preciznost i analogová duše.',
    'services.processing.title': 'Laboratorní práce',
    'services.processing.subtitle': 'Zpracování',
    'services.processing.desc': 'Poctivé vyvolávání černobílých filmů. Ruční proces s důrazem na řemeslo a kvalitu zrna.',
    'services.prints.title': 'Hmotný výsledek',
    'services.prints.subtitle': 'Tisky',
    'services.prints.desc': 'Unikátní zvětšeniny z temné komory na klasický fotopapír. Premium služba pro náročné.',
    'services.digital.title': 'Digitalizace',
    'services.digital.subtitle': 'Archiv',
    'services.digital.desc': 'DSLR skenování filmů ve vysokém rozlišení. Maximální detail a kontrola nad digitálním výstupem.',
  ...
  en: {
    ...
    'services.description': 'From capturing the moment to the final print \u2014 a complete photography service focused on the handmade process.',
    'services.capture.title': 'Capturing the moment',
    'services.capture.subtitle': 'Photography',
    'services.capture.desc': 'Portrait, product and event photography. Digital precision and analog soul.',
    'services.processing.title': 'Lab work',
    'services.processing.subtitle': 'Processing',
    'services.processing.desc': 'Honest black & white film development. A manual process with emphasis on craft and grain quality.',
    'services.prints.title': 'Tangible result',
    'services.prints.subtitle': 'Prints',
    'services.prints.desc': 'Unique darkroom enlargements on classic photographic paper. A premium service for the discerning.',
    'services.digital.title': 'Digitization',
    'services.digital.subtitle': 'Archive',
    'services.digital.desc': 'High-resolution DSLR film scanning. Maximum detail and control over the digital output.',
