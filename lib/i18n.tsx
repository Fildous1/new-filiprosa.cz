...
const translations: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    'projects.mafos.title': 'Mafoš',
    'projects.mafos.desc': 'DIY film scanner 3D printed for scanning 35mm and medium format film.',
    'projects.mafos.cta': 'View project',
    'projects.gear.title': 'Gear',

    // Mafos page
    'mafos.back': 'Back',
    'mafos.subtitle': '3D printed film scanner for 35mm and\u00A0medium format film',
    'mafos.about.heading': 'What is Mafoš',
    'mafos.about.p1': 'Mafoš is a film scanner designed and 3D printed from PLA. It enables scanning of 35mm and medium format negatives using a digital SLR camera and backlight from a\u00A0mobile phone.',
    'mafos.about.p2': 'It was born out of the need to scan over a hundred old family films found in my grandmother\'s house. Thanks to it, I managed to scan nearly 200 films and restore forgotten memories.',
    'mafos.about.stat1': '& medium format',
    'mafos.about.stat2': 'films scanned',
    'mafos.about.stat3': 'printed (PLA)',
    'mafos.conversion.heading': 'Conversion',
    ...
    'mafos.step1.desc': 'Raw negative shot captured with a digital SLR through the Mafoš scanner with phone backlight.',
    'mafos.step2': 'Crop & white balance',
    'mafos.step2.desc': 'Cropping to the frame area and correcting white balance for more accurate colors.',
    'mafos.step3': 'Positive conversion',
    'mafos.step3.desc': 'Inverting the negative colors into a positive image using Negative Lab Pro.',
    'mafos.step4': 'Color editing',
    'mafos.step4.desc': 'Fine-tuning color, contrast and exposure in Lightroom.',
    'mafos.step5': 'Final result',
    'mafos.step5.desc': 'The final scanned and edited photograph ready for export.',
    'mafos.diagram.heading': 'Diagram',
    'mafos.diagram.camera': 'Digital camera',
    'mafos.diagram.negative': 'Negative',
    'mafos.diagram.phone': 'Smartphone',
    'mafos.results.heading': 'Results',
    'mafos.results.p1': 'Comparison of a Mafoš scan with a professional lab scan. The results are comparable, with Mafoš offering more control over the final color grading.',
