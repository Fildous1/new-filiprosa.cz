...
const translations: Record<Locale, Record<string, string>> = {
  cs: {
    ...
    'services.prints.subtitle': 'Darkroom tisky',
    'services.prints.desc': 'Unikátní zvětšeniny z negativů v temné komoře. 10x15, 18x24 nebo i jiné rozměry.',
