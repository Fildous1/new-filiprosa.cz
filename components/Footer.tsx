      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-10 flex flex-col gap-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 md:gap-6">
          ...
          <address className="not-italic flex flex-col gap-1 text-[0.75rem] text-offwhite/60 font-body">
            ...
            <a href={`tel:${t('footer.business.phone').replace(/\s+/g, '')}`} className="hover:text-lime transition-colors duration-300 w-fit">
              {t('footer.business.phone')}
            </a>
            <a href={`mailto:${t('footer.business.email')}`} className="hover:text-lime transition-colors duration-300 w-fit">
              {t('footer.business.email')}
            </a>
          </address>

          {/* Center: nav links — vertically centered against the address block */}
          ...
          {/* Right: Instagram — vertically centered */}
          <a
